...
@dataclass
class UnitreeAliengoEnvConfig(BaseEnvConfig):
...
class UnitreeAliengoEnv(BaseEnv):
    def __init__(self, config: UnitreeAliengoEnvConfig):
        super().__init__(config)

        self._foot_radius = 0.0165 # Updated foot radius
    ...
    def make_system(self, config: UnitreeAliengoEnvConfig) -> System:
        model_path = get_model_path("aliengo", "aliengo.xml")
...
brax_envs.register_environment("unitree_aliengo_walk", UnitreeAliengoEnv)
